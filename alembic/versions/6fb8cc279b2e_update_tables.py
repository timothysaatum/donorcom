...
Revision ID: 6fb8cc279b2e
Revises:
Create Date: 2025-08-30 22:46:21.928783
...
def upgrade() -> None:
    ...
    # Create users table WITHOUT the work_facility_id foreign key constraint first
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["facility_manager_id"], ["users.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("facilities", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_facilities_facility_email"), ["facility_email"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_facilities_facility_manager_id"),
            ["facility_manager_id"],
            unique=True,
        )
        batch_op.create_index(batch_op.f("ix_facilities_id"), ["id"], unique=True)

    # NOW add the foreign key constraint to users table for work_facility_id
    op.create_foreign_key(
        "fk_users_work_facility_id",
        "users",
        "facilities",
        ["work_facility_id"],
        ["id"],
    ...
    with op.batch_alter_table("blood_banks", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_blood_banks_email"), ["email"], unique=True
        )
        batch_op.create_index(batch_op.f("ix_blood_banks_id"), ["id"], unique=True)
        batch_op.create_index(
            batch_op.f("ix_blood_banks_manager_id"), ["manager_id"], unique=True
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "request_status",
            sa.Enum(
                "pending", "accepted", "rejected", "cancelled", name="requeststatus"
            ),
            nullable=False,
        ),
        sa.Column(
            "processing_status",
            sa.Enum("pending", "dispatched", "completed", name="processingstatus"),
            nullable=False,
        ),
        sa.Column(
            "priority",
            sa.Enum("urgent", "not_urgent", name="prioritystatus"),
            nullable=True,
        ),
    ...
    with op.batch_alter_table("blood_requests", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_blood_requests_request_group_id"),
            ["request_group_id"],
            unique=False,
        )
    ...
    sa.Column("id", sa.UUID(), nullable=False),  # Changed from String to UUID
    sa.Column("moderator_id", sa.UUID(), nullable=True),  # Changed from String to UUID
    sa.Column("target_user_id", sa.UUID(), nullable=True),  # Changed from String to UUID
    ...
    sa.Column("user_id", sa.UUID(), nullable=False),  # Changed from String to UUID
    ...
    with op.batch_alter_table("user_sessions", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_user_sessions_device_fingerprint"),
            ["device_fingerprint"],
            unique=False,
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("ix_user_sessions_ip_address"), ["ip_address"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_sessions_is_active"), ["is_active"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_sessions_is_suspicious"),
            ["is_suspicious"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_user_sessions_last_activity"),
            ["last_activity"],
            unique=False,
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("ix_user_sessions_user_agent_hash"),
            ["user_agent_hash"],
            unique=False,
        )
        batch_op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["blood_bank_id"], ["blood_banks.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending_receive", "in_transit", "returned", name="distribution_status"
            ),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["blood_product_id"], ["blood_inventory.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["created_by_id"], ["users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["dispatched_from_id"], ["blood_banks.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["dispatched_to_id"], ["facilities.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("blood_distributions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_blood_distributions_id"), ["id"], unique=True
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["blood_distribution_id"], ["blood_distributions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["blood_request_id"], ["blood_requests.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["created_by_id"], ["users.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade() -> None:
    ...
    op.drop_table("impersonation_sessions")  # Just drop, don't recreate
    ...
    # Drop the foreign key constraint before dropping the facilities table
    op.drop_constraint("fk_users_work_facility_id", "users", type_="foreignkey")
