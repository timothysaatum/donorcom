...
class BloodInventoryService:
    ...
    async def get_paginated_blood_units(
        ...
        if current_user_blood_bank_id:
            conditions.append(BloodInventory.blood_bank_id == current_user_blood_bank_id)
        elif blood_bank_id:  # Fallback to provided blood_bank_id if no user bank provided
