...
class User(Base):
    ...
    # For staff and lab_manager - the facility they work at
    work_facility_id = Column(UUID(as_uuid=True), ForeignKey("facilities.id", ondelete="SET NULL"), nullable=True)
    ...
    # For facility_administrator - the facility they manage (one-to-one)
