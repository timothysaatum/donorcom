    ...
    async def checker(
        ...
        logger.info(
            ...
            extra={
                ...
                "user_id": str(current_user.id),
                "granted_permissions": [perm for perm in perms if current_user.has_permission(perm)],
    ...
    async def checker(
        ...
        logger.info(
            ...
            extra={
                ...
                "user_id": str(current_user.id),
                "granted_roles": [role for role in roles if current_user.has_role(role)],
                "session_validated": validate_session
            }
        )
...
def require_staff(validate_session: bool = True):
    ...
    """
    return require_role("facility_administrator", "lab_manager", "staff", validate_session=validate_session)
