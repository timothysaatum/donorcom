...
class SessionManager:
    ...
    async def terminate_all_user_sessions(
        db: AsyncSession, user_id: UUID, except_session_id: UUID = None
    ) -> int:
...
def get_password_hash(password: str) -> str:
    ...
    try:
        ...
        logger.error(
            ...
            extra={"event_type": "password_hashing_failed", "error": str(e)},
        )
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    try:
        ...
        logger.error(
            ...
            extra={"event_type": "password_verification_error", "error": str(e)},
        )
        return False
...
def create_verification_token(email: str, role: str, facility_id: str = None) -> str:
    ...
    payload = {"sub": email, "role": role, "exp": expire, "type": "email_verification"}
...
async def get_current_user(
    ...
    try:
        ...
        logger.warning(
            ...
            extra={"event_type": "invalid_auth_credentials", "error": str(e)},
        )
        raise HTTPException(
            status_code=status.HTTP_401_UNAUTHORIZED,
...
async def get_current_user_ws(websocket: WebSocket, db: AsyncSession) -> User:
    ...
    try:
        ...
        logger.warning(
            ...
            extra={"event_type": "websocket_auth_failed", "error": str(e)},
        )
        await websocket.close(code=1008)
        raise HTTPException(
    ...
    try:
        ...
        if count > 0:
            logger.info(
                ...
                extra={"event_type": "refresh_tokens_cleaned", "tokens_removed": count},
            )
        ...
        logger.error(
            ...
            extra={"event_type": "refresh_token_cleanup_failed", "error": str(e)},
            exc_info=True,
        )
        await db.rollback()
        return 0
